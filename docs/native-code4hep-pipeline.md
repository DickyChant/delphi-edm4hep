...
| Central tracking | scheduled TPC row aggregation, deterministic IP-constrained helix seed, VD association, exclusive ID/OD drift-side selection, and weighted partial-coordinate global refit with persistent hit relations | multi-track pattern recognition, sector-boundary merging, outlier rejection, material effects, track truth, unconstrained/beamspot fits |
