...
| Central tracking | scheduled TPC row aggregation, deterministic IP-constrained helix seed, VD association, exclusive ID/OD drift-side selection, weighted partial-coordinate global refit, and normalized track-to-MC attribution | multi-track pattern recognition, sector-boundary merging, outlier rejection, material effects, unconstrained/beamspot fits |
