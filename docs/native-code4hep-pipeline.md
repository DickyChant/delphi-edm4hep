...
| ID | authoritative sensitive geometry, transport hits, v94c jet/anode/cathode readout catalogue, and calibrated jet drift-time response | charge/noise response, digitization, hit building, truth links |
